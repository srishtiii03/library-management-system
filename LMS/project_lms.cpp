...
void student::creates()            //To enter values to all data members of class student
{
	...
	{
		cout<<"\n\t\tRecord already exists with this admission no.";
...
void write_book()			/*To Write object of class book in file*/
{
	book bk;
...
void write_student()			/*To Write object of class student in file*/
{
	student st;
...
void list_student() 			/*To display Student records in list form*/
{
	system("CLS");
	student st;
...
void list_book()		/*To display book records in list form*/
{
	book bk;
...
void search_student(int x)				/*To search for a specific student*/
{
	student st;
	int cnt=0;
	ifstream intf("student.bin",ios::in|ios::binary);
...
void search_book(int x)				/*To search for a specific book*/
{
	book bk;
	int cnt=0;
	ifstream intf("book1.bin",ios::in|ios::binary);
...
void modify_book(int x)			/*To modify the book records*/
{
	book bk;
	int cnt=0;
...
void modify_student(int x)			/*To modify the student records*/
{
	student st;
	int cnt=0;
...
void delete_student(int x)			/*To delete a specific student record*/
{
	student st;
	int cnt=0;
	ifstream intf("student.bin",ios::in|ios::binary);
...
void delete_book(int x)				/*To delete a specific book record*/
{
	book bk;
	int cnt=0;
	ifstream intf("book1.bin",ios::in|ios::binary);
...
bool res_student(int x)			//To search whether a specific student record exists or not
{
	student st;
	int cnt=0,f=0;
	ifstream intf("student.bin",ios::in|ios::binary);
...
int res_book(int x,int z)		/*To search a specific book and return true or false*/
{
	book bk;
	int cnt=0,f=1;
	fstream intf("book1.bin",ios::in|ios::out|ios::ate|ios::binary);
...
void book_issue()			/*To issue books*/
{
	int sn,bn;
	system("CLS");
	cout<<"\n\n\t\t*****BOOK ISSUE******";
		...
		while(outf.read(reinterpret_cast<char *>(&st),sizeof(student)))
		{
			if(st.admno==sn)
			{
				...
				if(flag==1)
				{
					...
					outf.write(reinterpret_cast<char *>(&st),sizeof(student));
					cout<<"\n\t\tBook Issued";
					cout<<"\n\t\tNote: The fine is Rs. 1 for each day after 15 days period\n";
					break;
				}
				else if(flag==2)
				{
...
void book_deposit()			/*To deposit books*/
{
	int sn,bn;
	system("CLS");
	cout<<"\n\n\t\t*****BOOK DEPOSIT******";
...
void admin_menu()		/*Function that has features of Admin Menu*/
{
fine:
	system("PAUSE");
	system("CLS");
